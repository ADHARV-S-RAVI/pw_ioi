...
const INITIAL_EVENTS = [
  ...
  },
  {
    ...
    price: 95.00,
    status: "Buy Ticket",
    // Fixed image URL for Rock the Cosmos Tour
...
const App = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'profile':
        return (
          <div className="max-w-3xl bg-zinc-900 rounded-[2.5rem] border border-zinc-800 overflow-hidden shadow-2xl">
            <div className="h-48 bg-gradient-to-r from-indigo-700 to-purple-800 relative">
               <div className="absolute inset-0 bg-black/20"></div>
            </div>
            <div className="px-10 pb-10">
              <div className="relative -mt-16 mb-8">
                <div className="w-32 h-32 rounded-3xl bg-zinc-900 border-8 border-zinc-950 p-1.5 shadow-2xl">
                  <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix" alt="avatar" className="w-full h-full rounded-2xl bg-zinc-800" />
                </div>
              </div>
              <div className="space-y-8">
                <div>
                  <h3 className="text-3xl font-black text-zinc-100 mb-2 tracking-tight">Alex Johnson</h3>
                  <div className="flex items-center space-x-4">
                    <span className="bg-indigo-500/10 text-indigo-400 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full">CS Major '25</span>
                    <span className="bg-zinc-800 text-zinc-500 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full">Verified Alpha</span>
                  </div>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-1">Algorand Wallet</label>
                    <div className="bg-zinc-950 p-4 rounded-2xl border border-zinc-800 text-zinc-300 text-xs font-mono break-all flex items-center justify-between group hover:border-indigo-500/30 transition-colors">
                      ZKJ3...X92A
                      <ExternalLink size={14} className="text-zinc-600 group-hover:text-indigo-500" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-1">Institutional ID</label>
                    <div className="bg-zinc-950 p-4 rounded-2xl border border-zinc-800 text-zinc-300 text-sm font-bold tracking-tight">
                      STU-2024-8891
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-zinc-800">
                   <h4 className="text-xs font-black text-zinc-500 uppercase tracking-[0.2em] mb-6">Security & Vault</h4>
                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex items-center justify-between p-4 bg-zinc-950 rounded-2xl border border-zinc-800 hover:bg-zinc-900 transition-colors cursor-pointer">
                         <div className="flex items-center space-x-4">
                            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-500">
                               <ShieldCheck size={20} />
                            </div>
                            <span className="text-sm font-bold text-zinc-300">Biometric Auth</span>
                         </div>
                         <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Active</span>
                      </div>
                      <div className="flex items-center justify-between p-4 bg-zinc-950 rounded-2xl border border-zinc-800 hover:bg-zinc-900 transition-colors cursor-pointer group">
                         <div className="flex items-center space-x-4">
                            <div className="w-10 h-10 rounded-xl bg-indigo-500/10 flex items-center justify-center text-indigo-500">
                               <History size={20} />
                            </div>
                            <span className="text-sm font-bold text-zinc-300">Audit Trail</span>
                         </div>
